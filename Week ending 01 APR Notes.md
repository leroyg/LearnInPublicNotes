Solved the leap year checker and the BMI with level specific feedback printed.
...
1- ***AGAIN*** Planning out my code; data I need, any manipulation of data needing to be performed, and the expected outcome - are very helpful and key.
...
I tried to use a for loop to solve the "Love Match" challenge, it wasn't the right tool because it looped back through each letter for each comparison, each time...I ended up counting each letter, each pass through. 
